...
struct PrinterSettingsView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            Text("Printer")
                .font(.headline)
            Text("On the printer, open Settings, then LAN or Network. Copy the IP address, access code, and serial number. PrintGlance only reads status on your Wi-Fi. It does not pause, stop, or start a print.")
                .font(.caption)
